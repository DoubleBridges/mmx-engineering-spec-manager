...
class GlobalPrompts(Base, PromptsMixin):
    """
    SQLAlchemy model for the 'global_prompts' table.
    """
    ...
    project = relationship("Project", back_populates="global_prompts")
    specification_group = relationship("SpecificationGroup", back_populates="global_prompts")